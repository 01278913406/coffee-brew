...
import org.chicha.cofi.share.model.SharedData
import org.chicha.cofi.share.utils.getActivity
import org.chicha.cofi.share.utils.verify_cofi_wear_app
...
object WearUtils {
    ...
    private const val COFI_PLAY_STORE_LINK =
        "https://play.google.com/store/apps/details?id=org.chicha.cofi"
